from evaluation.final02_foundation import (
...
def test_final02_route_mapping_covers_current_graph_entry_routes():
    report = evaluate_route_mapping()
    assert report["passed"] is True
    assert report["mapped_count"] == len(REQUIRED_ROUTE_MAPPINGS)


def test_final02_selective_planner_catalog_remains_deterministic_and_authority_safe():
